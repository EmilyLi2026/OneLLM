...
import { handler as onellmmoderateContent } from './onellm/moderateContent';
import { handler as onellmlanguage } from './onellm/language';
import { handler as onellmpii } from './onellm/pii';
import { handler as onellmgibberish } from './onellm/gibberish';
...
export const plugins = {
  ...
  onellm: {
    moderateContent: onellmmoderateContent,
    language: onellmlanguage,
    pii: onellmpii,
    gibberish: onellmgibberish,
  },
  aporia: {
