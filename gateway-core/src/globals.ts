...
export const POWERED_BY: string = 'onellm';
...
export const ALIBABA: string = 'alibaba'; // alias for dashscope
export const MINIMAX: string = 'minimax';
export const BYTEDANCE: string = 'bytedance';
export const BAICHUAN: string = 'baichuan';
export const BAIDU: string = 'baidu';
export const XUNFEI: string = 'xunfei';
export const TENCENT: string = 'tencent';
...
export const METRICS_KEYS = {
  ...
  ONELLM_MIDDLEWARE_PRE_REQUEST_START: 'onellmMiddlewarePreRequestStart',
  ONELLM_MIDDLEWARE_PRE_REQUEST_END: 'onellmMiddlewarePreRequestEnd',
  ONELLM_MIDDLEWARE_POST_REQUEST_START: 'onellmMiddlewarePostRequestStart',
  ONELLM_MIDDLEWARE_POST_REQUEST_END: 'onellmMiddlewarePostRequestEnd',
