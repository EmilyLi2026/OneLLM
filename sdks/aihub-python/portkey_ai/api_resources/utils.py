...
def default_base_url() -> str:
    ...
    env_base_url = os.environ.get(PORTKEY_PROXY_ENV)
    if env_base_url:
        return env_base_url
    # Fall back to AI Hub Gateway default
    from .global_constants import PORTKEY_GATEWAY_URL
...
def set_base_url(base_url, api_key):
    ...
    if env_base_url:
        return env_base_url
    api_key = api_key or os.environ.get(PORTKEY_API_KEY_ENV) or os.environ.get(AIHUB_API_KEY_ENV)
