...
export function LoginPage() {
  ...
  useEffect(() => {
    if (currentPhone && currentPhone !== prevPhoneRef.current) {
      ...
      setCountdown(0); // allow immediate re-send for a different number
    }
  }, [currentPhone]);
  ...
  const handleSendCode = async () => {
    ...
    try {
      ...
      if (res.data.status === 'success') {
        setCountdown(60);
        // Dev mode: auto-fill the code and show it
  ...
  const handleSubmit = async (values: { phone: string; code: string }) => {
    ...
    try {
      ...
      login(res.data.data.token, res.data.data.user, res.data.data.workspace);
    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 1,
          background: 'linear-gradient(90deg, transparent, rgba(59,130,246,0.3), rgba(99,102,241,0.3), rgba(59,130,246,0.3), transparent)',
        }} />
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 40 }}>
            ...
            <div>
              <div style={{ color: '#fff', fontSize: 26, fontWeight: 800, letterSpacing: -0.5, lineHeight: 1.1 }}>
                OneLLM
              </div>
              <div style={{ color: 'rgba(255,255,255,0.40)', fontSize: 12, fontWeight: 500, letterSpacing: 2, textTransform: 'uppercase' }}>
                Enterprise Gateway
              </div>
            </div>
          </div>
          ...
          <div style={{ marginBottom: 48 }}>
            <h1 style={{
              color: '#fff', fontSize: 34, fontWeight: 700, lineHeight: 1.25, margin: 0, letterSpacing: -1,
            }}>
              企业级 AI 网关
            </h1>
            <p style={{
              color: 'rgba(255,255,255,0.55)', fontSize: 15, lineHeight: 1.7, margin: '16px 0 0', maxWidth: 420,
            }}>
          ...
          <div style={{
            ...
            {stats.map((s) => (
              ...
              >
                ...
                <div style={{ color: '#fff', fontSize: 22, fontWeight: 700, letterSpacing: -0.5, marginBottom: 2 }}>
                  {s.value}
                </div>
                <div style={{ color: 'rgba(255,255,255,0.75)', fontSize: 13, fontWeight: 600, marginBottom: 3 }}>
                  {s.label}
                </div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <Form form={form} onFinish={handleSubmit} size="large">
            ...
            >
              <Input
                ...
                placeholder="请输入手机号"
                style={{
                  borderRadius: 10, height: 50, fontSize: 15,
            ...
            >
              <Input
                ...
                maxLength={6}
                style={{
                  borderRadius: 10, height: 50, fontSize: 15, letterSpacing: 3,
                  border: '1px solid #e2e8f0',
                }}
                suffix={
                  <Button
            ...
            <Form.Item style={{ marginBottom: 20 }}>
              <Button
                ...
                loading={loading}
                style={{
                  height: 50, borderRadius: 10, fontSize: 16, fontWeight: 600,
          ...
          {/* Divider with alternative login hint */}
          <div style={{
            display: 'flex', alignItems: 'center', gap: 12,
            marginTop: 36, marginBottom: 16,
          }}>
            <div style={{ flex: 1, height: 1, background: '#e2e8f0' }} />
            <span style={{ color: '#cbd5e1', fontSize: 12 }}>其他登录方式</span>
            <div style={{ flex: 1, height: 1, background: '#e2e8f0' }} />
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 20 }}>
            <div style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              cursor: 'not-allowed', opacity: 0.4, fontSize: 18,
            }} title="邮箱登录（即将上线）">
              📧
            </div>
            <div style={{
